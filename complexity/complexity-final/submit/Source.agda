...
module Source where
  ...
  subst-compose Θ v e = subst (subst e (s-extend Θ)) (q v) =⟨ ! (subst-ss (q v) (s-extend Θ) e) ⟩
                        subst e (q v ss s-extend Θ) =⟨ ap (subst e) (subst-compose-lemma v Θ) ⟩
                        (subst e (lem3' Θ v) ∎)
 -- same as ap (subst e) (subst-compose-lemma v Θ) ∘ (! (subst-ss (q v) (s-extend Θ) e)),
 -- just using equation chains for readers' sake
