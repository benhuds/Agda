...
--  subst (rrec e e₁ e₂ p) Θ = rrec (subst e Θ) (subst e₁ Θ) (subst e₂ Θ) (subst-cong p)
  ...
  c +C e = letc (prod (l-proj (var i0)) (r-proj (var i0))) e --prod (plusC c (l-proj e)) (r-proj e)
--use this for new bounding stuff letc (prod (l-proj (var i0)) (r-proj (var i0))) e
