...
-}
  ...
  s-rs-l-rec-lem-lem : ∀ {Γ Γ' Γ'' τ} (x : CTp) (ρ : rctx Γ Γ') (Θ : sctx Γ' (x :: Γ'')) (k : fst [ Γ ]c) (x₁ : fst (([ Γ ]c ×p [ τ ]t) ×p (Nat , ♭nat-p)))
  ...
  s-rs-l-rec-lem-lem {Γ} {Γ'} {Γ''} {τ} x ρ Θ k x₁ = {!!}
  ...
  s-rs-l-rec {Γ} {Γ'} {Γ'' = x :: Γ''} {τ} ρ Θ k x₁ = (s-rs-l-rec ρ (throw-s Θ) k x₁) , {!!}
