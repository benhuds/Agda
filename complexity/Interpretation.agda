...
{- DONE: S-ID, S-RR
  ...
  s-rr-l {Γ} {τ} (rrec {Γ''} {τ'} e e₁ e₂ P) ρ1 ρ2 k =
    Preorder-str.trans (snd [ τ' ]t)
      (Monotone.f (comp (pair' id (interpE (ren (ren e ρ2) ρ1)))
        (rec' (interpE (ren (ren e₁ ρ2) ρ1)) (unlam' (unlam' (interpE (ren (ren e₂ ρ2) ρ1))))
        (sound (ren (ren e₁ ρ2) ρ1) (app (app (ren (ren e₂ ρ2) ρ1) rz) (ren (ren e₁ ρ2) ρ1)) (ren-cong (ren-cong P))))) k)
      (Monotone.f (rec' (interpE (ren (ren e₁ (ρ2)) (ρ1))) (unlam' (unlam' (interpE (ren (ren e₂ (ρ2)) (ρ1)))))
        (λ x₁ → sound (ren (ren e₁ (ρ2)) ( ρ1)) (app (app (ren (ren e₂ (ρ2)) (ρ1)) rz) (ren (ren e₁ (ρ2)) (ρ1))) (ren-cong (ren-cong P)) x₁))
        (k , Monotone.f (interpE (ren e (( ρ1) ∙rr (ρ2)))) k))
      (Monotone.f
        (comp (pair' id (interpE (ren e (ρ1 ∙rr ρ2))))
          (rec' (interpE (ren e₁ (ρ1 ∙rr ρ2))) (unlam' (unlam' (interpE (ren e₂ (ρ1 ∙rr ρ2)))))
          (sound (ren e₁ (ρ1 ∙rr ρ2)) (app (app (ren e₂ (ρ1 ∙rr ρ2)) rz) (ren e₁ (ρ1 ∙rr ρ2))) (ren-cong P)))) k)
  ...
  s-rr-l {Γ} {Γ'} {Γ''} {τ} (listrec {.Γ''} {τ'} e e₁ e₂) ρ1 ρ2 k =
    Preorder-str.trans (snd [ τ ]t)
      (lrec (Monotone.f (interpE (ren (ren e ρ2) ρ1)) k)
        (Monotone.f (interpE (ren (ren e₁ ρ2) ρ1)) k)
        (λ x₁ x₂ x₃ → Monotone.f (interpE (ren (ren e₂ (r-extend (r-extend (r-extend ρ2)))) (r-extend (r-extend (r-extend ρ1))))) (((k , x₃) , x₂) , x₁)))
      (lrec (Monotone.f (interpE (ren e (λ x → ρ1 (ρ2 x)))) k)
        (Monotone.f (interpE (ren (ren e₁ ρ2) ρ1)) k)
        (λ x₁ x₂ x₃ → Monotone.f (interpE (ren (ren e₂ (r-extend (r-extend (r-extend ρ2)))) (r-extend (r-extend (r-extend ρ1))))) (((k , x₃) , x₂) , x₁)))
      (lrec (Monotone.f (interpE (ren e (λ x → ρ1 (ρ2 x)))) k)
        (Monotone.f (interpE (ren e₁ (λ x → ρ1 (ρ2 x)))) k)
        (λ x₁ x₂ x₃ → Monotone.f (interpE (ren e₂ (r-extend (r-extend (r-extend (λ x → ρ1 (ρ2 x))))))) (((k , x₃) , x₂) , x₁)))
      (listrec-fix-args (interpE (ren (ren e₁ ρ2) ρ1)) (interpE (ren (ren e₂ (r-extend (r-extend (r-extend ρ2)))) (r-extend (r-extend (r-extend ρ1)))))
        (k , Monotone.f (interpE (ren (ren e ρ2) ρ1)) k)
        (k , Monotone.f (interpE (ren e (λ x → ρ1 (ρ2 x)))) k)
          ((Preorder-str.refl (snd [ Γ ]c) k) , (s-rr-l e ρ1 ρ2 k)))
      (lrec-cong
        (interpE (ren (ren e₁ ρ2) ρ1))
        (interpE (ren e₁ (λ x → ρ1 (ρ2 x))))
        (interpE (ren (ren e₂ (r-extend (r-extend (r-extend ρ2)))) (r-extend (r-extend (r-extend ρ1)))))
        (interpE (ren e₂ (r-extend (r-extend (r-extend (λ x → ρ1 (ρ2 x)))))))
        (k , Monotone.f (interpE (ren e (λ x → ρ1 (ρ2 x)))) k)
          (λ x → s-rr-l e₁ ρ1 ρ2 x)
          (λ x →
            Preorder-str.trans (snd [ τ ]t)
              (Monotone.f (interpE (ren (ren e₂ (r-extend (r-extend (r-extend ρ2)))) (r-extend (r-extend (r-extend ρ1))))) x)
              (Monotone.f (interpE (ren e₂ (r-extend (r-extend (r-extend ρ1)) ∙rr r-extend (r-extend (r-extend ρ2))))) x)
              (Monotone.f (interpE (ren e₂ (r-extend (r-extend (r-extend (λ x₁ → ρ1 (ρ2 x₁))))))) x)
                (s-rr-l e₂ (r-extend (r-extend (r-extend ρ1))) (r-extend (r-extend (r-extend ρ2))) x)
                (Preorder-str.trans (snd [ τ ]t)
                  (Monotone.f (interpE (ren e₂ (r-extend (r-extend (r-extend ρ1)) ∙rr r-extend (r-extend (r-extend ρ2))))) x)
                  (Monotone.f (interpE e₂) (Monotone.f (interpR {τ' :: list τ' :: τ :: Γ} {τ' :: list τ' :: τ :: Γ''} (r-extend (r-extend (r-extend (λ x₁ → ρ1 (ρ2 x₁)))))) x))
                  (Monotone.f (interpE (ren e₂ (r-extend (r-extend (r-extend (λ x₁ → ρ1 (ρ2 x₁))))))) x)
                    (Preorder-str.trans (snd [ τ ]t)
                      (Monotone.f (interpE (ren e₂ (r-extend (r-extend (r-extend ρ1)) ∙rr r-extend (r-extend (r-extend ρ2))))) x)
                      (Monotone.f (interpE e₂)
                        (Monotone.f (interpR {τ' :: list τ' :: τ :: Γ} {τ' :: list τ' :: τ :: Γ''} (r-extend (r-extend (r-extend ρ1)) ∙rr r-extend (r-extend (r-extend ρ2)))) x))
                      (Monotone.f (interpE e₂)
                        (Monotone.f (interpR {τ' :: list τ' :: τ :: Γ} {τ' :: list τ' :: τ :: Γ''} (r-extend (r-extend (r-extend (λ x₁ → ρ1 (ρ2 x₁)))))) x))
                      (ren-eq-l (r-extend (r-extend (r-extend ρ1)) ∙rr r-extend (r-extend (r-extend ρ2))) e₂ x)
                      (Monotone.is-monotone (interpE e₂)
                        (Monotone.f (interpR {τ' :: list τ' :: τ :: Γ} {τ' :: list τ' :: τ :: Γ''} (r-extend (r-extend (r-extend ρ1)) ∙rr r-extend (r-extend (r-extend ρ2)))) x)
                        (Monotone.f (interpR {τ' :: list τ' :: τ :: Γ} {τ' :: list τ' :: τ :: Γ''} (r-extend (r-extend (r-extend (λ x₁ → ρ1 (ρ2 x₁)))))) x)
                          (((Preorder-str.refl (snd [ Γ'' ]c) (Monotone.f (interpR (λ x₁ → iS (iS (iS (ρ1 (ρ2 x₁)))))) x) ,
                          Preorder-str.refl (snd [ τ ]t) (snd (fst (fst x)))) ,
                          l-refl (snd [ τ' ]t) (snd (fst x))) ,
                          Preorder-str.refl (snd [ τ' ]t) (snd x))))
                  (ren-eq-r (r-extend (r-extend (r-extend (λ x₁ → ρ1 (ρ2 x₁))))) e₂ x))))
  s-rr-l true ρ1 ρ2 k = <>
  ...
  s-rr-r {Γ} {τ} (rec {Γ''} {τ'} e e₁ e₂) ρ1 ρ2 k =
    Preorder-str.trans (snd [ τ' ]t)
      (natrec (Monotone.f (interpE (ren e₁ (λ x → ρ1 (ρ2 x)))) k)
        (λ n x₂ → Monotone.f (interpE (ren e₂ (r-extend (r-extend (λ x → ρ1 (ρ2 x)))))) ((k , x₂) , n))
        (Monotone.f (interpE (ren e (λ x → ρ1 (ρ2 x)))) k))
                ...
                (Preorder-str.trans (snd [ τ' ]t)
                  ...
                  (Monotone.f (interpE (ren e₂ (r-extend (r-extend ρ1) ∙rr r-extend (r-extend ρ2)))) x)
                    (Preorder-str.trans (snd [ τ' ]t)
                      ...
                      (Monotone.f (interpE e₂) (Monotone.f (interpR {nat :: τ' :: Γ} {nat :: τ' :: Γ''} (r-extend (r-extend (λ x₁ → ρ1 (ρ2 x₁))))) x))
                      (Monotone.f (interpE e₂) (Monotone.f (interpR {nat :: τ' :: Γ} {nat :: τ' :: Γ''} (r-extend (r-extend ρ1) ∙rr r-extend (r-extend ρ2))) x))
                        (ren-eq-l (r-extend (r-extend (λ x₁ → ρ1 (ρ2 x₁)))) e₂ x)
                        (Monotone.is-monotone (interpE e₂)
                          (Monotone.f (interpR {nat :: τ' :: Γ} {nat :: τ' :: Γ''} (r-extend (r-extend (λ x₁ → ρ1 (ρ2 x₁))))) x)
                          (Monotone.f (interpR {nat :: τ' :: Γ} {nat :: τ' :: Γ''} (r-extend (r-extend ρ1) ∙rr r-extend (r-extend ρ2))) x)
                            (((Preorder-str.refl (snd [ Γ'' ]c) (Monotone.f (interpR (λ x₁ → iS (iS (ρ1 (ρ2 x₁))))) x)) ,
                            (Preorder-str.refl (snd [ τ' ]t) (snd (fst x)))) ,
                            (♭nat-refl (snd x)))))
                    (ren-eq-r (r-extend (r-extend ρ1) ∙rr r-extend (r-extend ρ2)) e₂ x))
                (s-rr-r e₂ (r-extend (r-extend ρ1)) (r-extend (r-extend ρ2)) x)))
      (♭h-fix-args (interpE (ren (ren e₁ ρ2) ρ1)) (interpE (ren (ren e₂ (r-extend (r-extend ρ2))) (r-extend (r-extend ρ1))))
        (k , Monotone.f (interpE (ren e (λ x → ρ1 (ρ2 x)))) k)
        (k , Monotone.f (interpE (ren (ren e ρ2) ρ1)) k)
          (s-rr-r e ρ1 ρ2 k))
  ...
  s-rr-r {Γ} {τ} (rrec {Γ''} {τ'} e e₁ e₂ P) ρ1 ρ2 k =
    Preorder-str.trans (snd [ τ' ]t)
      (Monotone.f (comp (pair' id (interpE (ren e (ρ1 ∙rr ρ2))))
        (rec' (interpE (ren e₁ (ρ1 ∙rr ρ2))) (unlam' (unlam' (interpE (ren e₂ (ρ1 ∙rr ρ2)))))
        (sound (ren e₁ (ρ1 ∙rr ρ2)) (app (app (ren e₂ (ρ1 ∙rr ρ2)) rz) (ren e₁ (ρ1 ∙rr ρ2))) (ren-cong P)))) k)
      (Monotone.f (rec' (interpE (ren (ren e₁ ρ2) ρ1)) (unlam' (unlam' (interpE (ren (ren e₂ ρ2) ρ1))))
        (λ x₁ → sound (ren (ren e₁ ρ2) ρ1) (app (app (ren (ren e₂ ρ2) ρ1) rz) (ren (ren e₁ ρ2) ρ1)) (ren-cong (ren-cong P)) x₁))
      ...
      (h-cong2
        ...
        (unlam' (unlam' (interpE (ren (ren e₂ ρ2) ρ1))))
        (λ x → s-rr-r e₁ ρ1 ρ2 x)
        (λ x → s-rr-r e₂ ρ1 ρ2 (fst (fst x)) (snd (fst x)) (snd x))
          (λ x₁ → sound (ren e₁ (ρ1 ∙rr ρ2)) (app (app (ren e₂ (ρ1 ∙rr ρ2)) rz) (ren e₁ (ρ1 ∙rr ρ2))) (ren-cong P) x₁)
          (λ x₁ → sound (ren (ren e₁ ρ2) ρ1) (app (app (ren (ren e₂ ρ2) ρ1) rz) (ren (ren e₁ ρ2) ρ1)) (ren-cong (ren-cong P)) x₁)
          (k , Monotone.f (interpE (ren e (ρ1 ∙rr ρ2))) k))
      (h-lem2 (interpE (ren (ren e₁ ρ2) ρ1)) (unlam' (unlam' (interpE (ren (ren e₂ ρ2) ρ1))))
  ...
  s-rr-r {Γ} {Γ'} {Γ''} {τ} (listrec {.Γ''} {τ'} e e₁ e₂) ρ1 ρ2 k =
    Preorder-str.trans (snd [ τ ]t)
      (lrec (Monotone.f (interpE (ren e (λ x → ρ1 (ρ2 x)))) k)
        (Monotone.f (interpE (ren e₁ (λ x → ρ1 (ρ2 x)))) k)
        (λ x₁ x₂ x₃ → Monotone.f (interpE (ren e₂ (r-extend (r-extend (r-extend (λ x → ρ1 (ρ2 x))))))) (((k , x₃) , x₂) , x₁)))
          ...
          (λ x →
            Preorder-str.trans (snd [ τ ]t)
              ...
              (Preorder-str.trans (snd [ τ ]t)
                ...
                (Monotone.f (interpE e₂) (Monotone.f (interpR {τ' :: list τ' :: τ :: Γ} {τ' :: list τ' :: τ :: Γ''} (r-extend (r-extend (r-extend (λ x₁ → ρ1 (ρ2 x₁)))))) x))
                (Monotone.f (interpE (ren e₂ (r-extend (r-extend (r-extend ρ1)) ∙rr r-extend (r-extend (r-extend ρ2))))) x)
                (ren-eq-l (r-extend (r-extend (r-extend (λ x₁ → ρ1 (ρ2 x₁))))) e₂ x)
                (Preorder-str.trans (snd [ τ ]t)
                  (Monotone.f (interpE e₂)
                    (Monotone.f (interpR {τ' :: list τ' :: τ :: Γ} {τ' :: list τ' :: τ :: Γ''} (r-extend (r-extend (r-extend (λ x₁ → ρ1 (ρ2 x₁)))))) x))
                  (Monotone.f (interpE e₂)
                  ...
                  (Monotone.is-monotone (interpE e₂)
                    ...
                    (Monotone.f (interpR {τ' :: list τ' :: τ :: Γ} {τ' :: list τ' :: τ :: Γ''} (r-extend (r-extend (r-extend ρ1)) ∙rr r-extend (r-extend (r-extend ρ2)))) x)
                      ...
                      l-refl (snd [ τ' ]t) (snd (fst x))) ,
                      Preorder-str.refl (snd [ τ' ]t) (snd x)))
                  (ren-eq-r (r-extend (r-extend (r-extend ρ1)) ∙rr r-extend (r-extend (r-extend ρ2))) e₂ x)))
              (s-rr-r e₂ (r-extend (r-extend (r-extend ρ1))) (r-extend (r-extend (r-extend ρ2))) x)))
      (listrec-fix-args (interpE (ren (ren e₁ ρ2) ρ1)) (interpE (ren (ren e₂ (r-extend (r-extend (r-extend ρ2)))) (r-extend (r-extend (r-extend ρ1)))))
        (k , Monotone.f (interpE (ren e (λ x → ρ1 (ρ2 x)))) k)
        (k , Monotone.f (interpE (ren (ren e ρ2) ρ1)) k)
          ((Preorder-str.refl (snd [ Γ ]c) k) , (s-rr-r e ρ1 ρ2 k)))
  s-rr-r true ρ1 ρ2 k = <>
...
-}
  ...
  s-rs-l-rec-lem-lem : ∀ {Γ Γ' τ} (x : CTp) (ρ : rctx Γ Γ') (k : fst [ Γ ]c) (x₁ : fst (([ Γ ]c ×p [ τ ]t) ×p (Nat , ♭nat-p)))
                     → Preorder-str.≤ (snd [ Γ' ]c)
                       (Monotone.f (interpR {τ :: Γ'} {Γ'} iS) (Monotone.f (interpR {nat :: τ :: Γ'} {τ :: Γ'} iS)
                         (Monotone.f (interpR {nat :: τ :: Γ} {nat :: τ :: Γ'} (r-extend (r-extend ρ))) x₁)))
                       (Monotone.f (interpR ρ) (Monotone.f (interpR {τ :: Γ} {Γ} iS) (Monotone.f (interpR {nat :: τ :: Γ} {τ :: Γ} iS) x₁)))
  s-rs-l-rec-lem-lem {Γ' = []} x ρ k x₁ = <>
  s-rs-l-rec-lem-lem {Γ} {Γ' = x :: Γ'} {τ} x₁ ρ k x₂ =
    (fst (s-rs-l-rec-lem-lem x ρ k x₂)) ,
    (Monotone.is-monotone (lookup (ρ i0))
      (fst (fst x₂))
      (Monotone.f (interpR {τ :: Γ} {Γ} iS) (Monotone.f (interpR {nat :: τ :: Γ} {τ :: Γ} iS) x₂))
        (Preorder-str.trans (snd [ Γ ]c)
          (fst (fst x₂))
          (Monotone.f (interpR {Γ} {Γ} (λ x₃ → x₃)) (fst (fst x₂)))
          (Monotone.f (interpR {τ :: Γ} {Γ} iS) (Monotone.f (interpR {nat :: τ :: Γ} {τ :: Γ} iS) x₂))
          (ids-lem-r {Γ} (fst (fst x₂)))
          (Preorder-str.trans (snd [ Γ ]c)
            (Monotone.f (interpR {Γ} {Γ} (λ x₃ → x₃)) (fst (fst x₂)))
            (Monotone.f (interpR {τ :: Γ} {Γ} (throw-r (r-extend (λ x₃ → x₃)))) (fst (fst x₂) , snd (fst x₂)))
            (Monotone.f (interpR {τ :: Γ} {Γ} iS) (Monotone.f (interpR {nat :: τ :: Γ} {τ :: Γ} iS) x₂))
            (ren-eq-r-lam {Γ} {Γ} (λ x₃ → x₃) (fst (fst x₂)) (snd (fst x₂)))
            (Monotone.is-monotone (interpR {τ :: Γ} {Γ} iS)
              (fst (fst x₂) , snd (fst x₂))
              (Monotone.f (interpR {nat :: τ :: Γ} {τ :: Γ} iS) x₂)
                (Preorder-str.trans (snd [ Γ ]c)
                  (fst (fst x₂))
                  (Monotone.f (interpR {Γ} {Γ} (λ x₃ → x₃)) (fst (fst x₂)))
                  (Monotone.f (interpR {nat :: τ :: Γ} {Γ} (λ x₃ → iS (iS x₃))) x₂)
                  (ids-lem-r {Γ} (fst (fst x₂)))
                  (Preorder-str.trans (snd [ Γ ]c)
                    (Monotone.f (interpR {Γ} {Γ} (λ x₃ → x₃)) (fst (fst x₂)))
                    (Monotone.f (interpR {τ :: Γ} {Γ} (throw-r (r-extend (λ x₃ → x₃)))) (fst (fst x₂) , snd (fst x₂)))
                    (Monotone.f (interpR {nat :: τ :: Γ} {Γ} (λ x₃ → iS (iS x₃))) x₂)
                    (ren-eq-r-lam {Γ} {Γ} (λ x₃ → x₃) (fst (fst x₂)) (snd (fst x₂)))
                    (ren-eq-r-lam {τ :: Γ} {Γ} (λ x₃ → iS x₃) (fst x₂) (snd x₂))) ,
                Preorder-str.refl (snd [ τ ]t) (snd (fst x₂)))))))

  s-rs-l-rec-lem : ∀ {Γ Γ' Γ'' τ} (x : CTp) (ρ : rctx Γ Γ') (Θ : sctx Γ' (x :: Γ'')) (k : fst [ Γ ]c) (x₁ : fst (([ Γ ]c ×p [ τ ]t) ×p (Nat , ♭nat-p)))
                 → Preorder-str.≤ (snd [ x ]t)
                   (Monotone.f (interpE {nat :: τ :: Γ} {x} (ren (ren (ren (Θ i0) iS) iS) (r-extend (r-extend ρ)))) x₁)
                   (Monotone.f (interpE {nat :: τ :: Γ} {x} (ren (ren (ren (Θ i0) ρ) iS) iS)) x₁)
  s-rs-l-rec-lem {Γ} {Γ'} {Γ''} {τ} x ρ Θ k x₁ =
    Preorder-str.trans (snd [ x ]t)
      (Monotone.f (interpE {nat :: τ :: Γ} {x} (ren (ren (ren (Θ i0) iS) iS) (r-extend (r-extend ρ)))) x₁)
      (Monotone.f (interpE (ren (ren (Θ i0) iS) iS)) (Monotone.f (interpR {nat :: τ :: Γ} (r-extend (r-extend ρ))) x₁))
      (Monotone.f (interpE {nat :: τ :: Γ} {x} (ren (ren (ren (Θ i0) ρ) iS) iS)) x₁)
      (ren-eq-l (r-extend (r-extend ρ)) (ren (ren (Θ i0) iS) iS) x₁)
      (Preorder-str.trans (snd [ x ]t)
        (Monotone.f (interpE (ren (ren (Θ i0) iS) iS)) (Monotone.f (interpR {nat :: τ :: Γ} (r-extend (r-extend ρ))) x₁))
        (Monotone.f (interpE (ren (ren (Θ i0) ρ) iS)) (Monotone.f (interpR {_} {τ :: Γ} iS) x₁))
        (Monotone.f (interpE {nat :: τ :: Γ} {x} (ren (ren (ren (Θ i0) ρ) iS) iS)) x₁)
        (Preorder-str.trans (snd [ x ]t)
          (Monotone.f (interpE (ren (ren (Θ i0) iS) iS)) (Monotone.f (interpR {nat :: τ :: Γ} (r-extend (r-extend ρ))) x₁))
          (Monotone.f (interpE (ren (Θ i0) iS)) (Monotone.f (interpR {_} {τ :: Γ'} iS) (Monotone.f (interpR {nat :: τ :: Γ} {nat :: τ :: Γ'} (r-extend (r-extend ρ))) x₁)))
          (Monotone.f (interpE (ren (ren (Θ i0) ρ) iS)) (Monotone.f (interpR {_} {τ :: Γ} iS) x₁))
          (ren-eq-l iS (ren (Θ i0) iS) (Monotone.f (interpR {nat :: τ :: Γ} (r-extend (r-extend ρ))) x₁))
          (Preorder-str.trans (snd [ x ]t)
            (Monotone.f (interpE (ren (Θ i0) iS)) (Monotone.f (interpR {_} {τ :: Γ'} iS) (Monotone.f (interpR {nat :: τ :: Γ} {nat :: τ :: Γ'} (r-extend (r-extend ρ))) x₁)))
            (Monotone.f (interpE (ren (Θ i0) ρ)) (Monotone.f (interpR {_} {Γ} iS) (Monotone.f (interpR {nat :: τ :: Γ} {τ :: Γ} iS) x₁)))
            (Monotone.f (interpE (ren (ren (Θ i0) ρ) iS)) (Monotone.f (interpR {_} {τ :: Γ} iS) x₁))
            (Preorder-str.trans (snd [ x ]t)
              (Monotone.f (interpE (ren (Θ i0) iS)) (Monotone.f (interpR {_} {τ :: Γ'} iS)
                (Monotone.f (interpR {nat :: τ :: Γ} {nat :: τ :: Γ'} (r-extend (r-extend ρ))) x₁)))
              (Monotone.f (interpE (Θ i0)) (Monotone.f (interpR {_} {Γ'} iS)
                (Monotone.f (interpR {nat :: τ :: Γ'} {τ :: Γ'}iS) (Monotone.f (interpR {nat :: τ :: Γ} {nat :: τ :: Γ'} (r-extend (r-extend ρ))) x₁))))
              (Monotone.f (interpE (ren (Θ i0) ρ)) (Monotone.f (interpR {_} {Γ} iS) (Monotone.f (interpR {nat :: τ :: Γ} {τ :: Γ} iS) x₁)))
              (ren-eq-l iS (Θ i0) (Monotone.f (interpR {_} {τ :: Γ'} iS) (Monotone.f (interpR {nat :: τ :: Γ} {nat :: τ :: Γ'} (r-extend (r-extend ρ))) x₁)))
              (Preorder-str.trans (snd [ x ]t)
                (Monotone.f (interpE (Θ i0)) (Monotone.f (interpR {_} {Γ'} iS)
                  (Monotone.f (interpR {nat :: τ :: Γ'} {τ :: Γ'} iS) (Monotone.f (interpR {nat :: τ :: Γ} {nat :: τ :: Γ'} (r-extend (r-extend ρ))) x₁))))
                (Monotone.f (interpE (Θ i0)) (Monotone.f (interpR ρ) (Monotone.f (interpR {_} {Γ} iS) (Monotone.f (interpR {nat :: τ :: Γ} {τ :: Γ} iS) x₁))))
                (Monotone.f (interpE (ren (Θ i0) ρ)) (Monotone.f (interpR {_} {Γ} iS) (Monotone.f (interpR {nat :: τ :: Γ} {τ :: Γ} iS) x₁)))
                (Monotone.is-monotone (interpE (Θ i0))
                  (Monotone.f (interpR {_} {Γ'} iS) (Monotone.f (interpR {nat :: τ :: Γ'} {τ :: Γ'} iS)
                    (Monotone.f (interpR {nat :: τ :: Γ} {nat :: τ :: Γ'} (r-extend (r-extend ρ))) x₁)))
                  (Monotone.f (interpR ρ) (Monotone.f (interpR {_} {Γ} iS) (Monotone.f (interpR {nat :: τ :: Γ} {τ :: Γ} iS) x₁)))
                  (s-rs-l-rec-lem-lem x ρ k x₁))
                (ren-eq-r ρ (Θ i0) (Monotone.f (interpR {_} {Γ} iS) (Monotone.f (interpR {nat :: τ :: Γ} {τ :: Γ} iS) x₁)))))
            (ren-eq-r iS (ren (Θ i0) ρ) (Monotone.f (interpR {_} {τ :: Γ} iS) x₁))))
        (ren-eq-r iS (ren (ren (Θ i0) ρ) iS) x₁))

  s-rs-l-rec : ∀ {Γ Γ' Γ'' τ} (ρ : rctx Γ Γ') (Θ : sctx Γ' Γ'') (k : fst [ Γ ]c) (x : fst (((fst [ Γ ]c , snd [ Γ ]c) ×p (fst [ τ ]t , snd [ τ ]t)) ×p (Nat , ♭nat-p)))
             → Preorder-str.≤ (snd [ Γ'' ]c)
               (Monotone.f (interpS {nat :: τ :: Γ} {Γ''} (λ x₁ → ren (ren (ren (Θ x₁) iS) iS) (r-extend (r-extend (ρ))))) x)
               (Monotone.f (interpS {nat :: τ :: Γ} {Γ''} (λ x₁ → ren (ren (ren (Θ x₁) ρ) iS) iS)) x)
  s-rs-l-rec {Γ'' = []} ρ Θ k x = <>
  s-rs-l-rec {Γ} {Γ'} {Γ'' = x :: Γ''} {τ} ρ Θ k x₁ = (s-rs-l-rec ρ (throw-s Θ) k x₁) , s-rs-l-rec-lem x ρ Θ k x₁
  ...
  s-rs-l {Γ} {Γ'} {Γ''} {τ} ρ Θ (rec {.Γ''} {.τ} e e₁ e₂) k =
    Preorder-str.trans (snd [ τ ]t)
      (natrec (Monotone.f (interpE (ren (subst e₁ Θ) ρ)) k)
        (λ n x₂ → Monotone.f (interpE (ren (subst e₂ (s-extend (s-extend Θ))) (r-extend (r-extend ρ)))) ((k , x₂) , n))
        (Monotone.f (interpE (ren (subst e Θ) ρ)) k))
      (natrec (Monotone.f (interpE (ren (subst e₁ Θ) ρ)) k)
        (λ n x₂ → Monotone.f (interpE (ren (subst e₂ (s-extend (s-extend Θ))) (r-extend (r-extend ρ)))) ((k , x₂) , n))
        (Monotone.f (interpE (subst e (ρ rs Θ))) k))
      (natrec (Monotone.f (interpE (subst e₁ (λ x → ren (Θ x) ρ))) k)
        (λ n x₂ → Monotone.f (interpE (subst e₂ (s-extend (s-extend (λ x → ren (Θ x) ρ))))) ((k , x₂) , n))
        (Monotone.f (interpE (subst e (λ x → ren (Θ x) ρ))) k))
      (♭h-fix-args (interpE (ren (subst e₁ Θ) ρ)) (interpE (ren (subst e₂ (s-extend (s-extend Θ))) (r-extend (r-extend ρ))))
      ...
      (♭h-cong
        ...
        (interpE (ren (subst e₂ (s-extend (s-extend Θ))) (r-extend (r-extend ρ))))
        (interpE (subst e₂ (s-extend (s-extend (λ x → ren (Θ x) ρ)))))
        (k , Monotone.f (interpE (subst e (λ x → ren (Θ x) ρ))) k)
          (λ x → s-rs-l ρ Θ e₁ x)
          (λ x →
            Preorder-str.trans (snd [ τ ]t)
              (Monotone.f (interpE (ren (subst e₂ (s-extend (s-extend Θ))) (r-extend (r-extend ρ)))) x)
              (Monotone.f (interpE (subst e₂ (r-extend (r-extend ρ) rs s-extend (s-extend Θ)))) x)
              (Monotone.f (interpE (subst e₂ (s-extend (s-extend (λ x₁ → ren (Θ x₁) ρ))))) x)
              (s-rs-l (r-extend (r-extend ρ)) (s-extend (s-extend Θ)) e₂ x)
              (Preorder-str.trans (snd [ τ ]t)
                (Monotone.f (interpE (subst e₂ (r-extend (r-extend ρ) rs s-extend (s-extend Θ)))) x)
                (Monotone.f (interpE e₂) (Monotone.f (interpS {nat :: τ :: Γ} {nat :: τ :: Γ''} (s-extend (s-extend (λ x₁ → ren (Θ x₁) ρ)))) x))
                (Monotone.f (interpE (subst e₂ (s-extend (s-extend (λ x₁ → ren (Θ x₁) ρ))))) x)
                (Preorder-str.trans (snd [ τ ]t)
                  (Monotone.f (interpE (subst e₂ (r-extend (r-extend ρ) rs s-extend (s-extend Θ)))) x)
                  (Monotone.f (interpE e₂) (Monotone.f (interpS {nat :: τ :: Γ} {nat :: τ :: Γ''} (r-extend (r-extend ρ) rs s-extend (s-extend Θ))) x))
                  (Monotone.f (interpE e₂) (Monotone.f (interpS {nat :: τ :: Γ} {nat :: τ :: Γ''} (s-extend (s-extend (λ x₁ → ren (Θ x₁) ρ)))) x))
                  (subst-eq-l (r-extend (r-extend ρ) rs s-extend (s-extend Θ)) e₂ x)
                  (Monotone.is-monotone (interpE e₂)
                    (Monotone.f (interpS {nat :: τ :: Γ} {nat :: τ :: Γ''} (r-extend (r-extend ρ) rs s-extend (s-extend Θ))) x)
                    (Monotone.f (interpS {nat :: τ :: Γ} {nat :: τ :: Γ''} (s-extend (s-extend (λ x₁ → ren (Θ x₁) ρ)))) x)
                      ((s-rs-l-rec ρ Θ k x ,
                      (Preorder-str.refl (snd [ τ ]t) (snd (fst x)))) ,
                      (♭nat-refl (snd x)))))
                (subst-eq-r (s-extend (s-extend (λ x₁ → ren (Θ x₁) ρ))) e₂ x))))
  ...
  s-rs-l {Γ} {Γ'} {Γ''} {τ} ρ Θ (rrec {.Γ''} {.τ} e e₁ e₂ P) k =
    Preorder-str.trans (snd [ τ ]t)
      (Monotone.f (comp (pair' id (interpE (ren (subst e Θ) ρ)))
        (rec' (interpE (ren (subst e₁ Θ) ρ)) (unlam' (unlam' (interpE (ren (subst e₂ Θ) ρ))))
        (sound (ren (subst e₁ Θ) ρ) (app (app (ren (subst e₂ Θ) ρ) rz) (ren (subst e₁ Θ) ρ)) (ren-cong (subst-cong P))))) k)
      (Monotone.f (rec' (interpE (ren (subst e₁ Θ) ρ)) (unlam' (unlam' (interpE (ren (subst e₂ Θ) ρ))))
        (λ x₁ → sound (ren (subst e₁ Θ) ρ) (app (app (ren (subst e₂ Θ) ρ) rz) (ren (subst e₁ Θ) ρ)) (ren-cong (subst-cong P)) x₁))
        (k , Monotone.f (interpE (subst e (ρ rs Θ))) k))
      (Monotone.f (comp (pair' id (interpE (subst e (ρ rs Θ))))
        (rec' (interpE (subst e₁ (ρ rs Θ))) (unlam' (unlam' (interpE (subst e₂ (ρ rs Θ)))))
        (sound (subst e₁ (ρ rs Θ)) (app (app (subst e₂ (ρ rs Θ)) rz) (subst e₁ (ρ rs Θ))) (subst-cong P)))) k)
      (h-lem2 (interpE (ren (subst e₁ Θ) ρ)) (unlam' (unlam' (interpE (ren (subst e₂ Θ) ρ))))
        (k , Monotone.f (interpE (ren (subst e Θ) ρ)) k)
        (k , Monotone.f (interpE (subst e (ρ rs Θ))) k)
        (λ x → sound (ren (subst e₁ Θ) ρ) (app (app (ren (subst e₂ Θ) ρ) rz) (ren (subst e₁ Θ) ρ)) (ren-cong (subst-cong P)) x)
          (s-rs-l ρ Θ e k))
      (h-cong2
        (interpE (ren (subst e₁ Θ) ρ))
        (interpE (subst e₁ (ρ rs Θ)))
        (unlam' (unlam' (interpE (ren (subst e₂ Θ) ρ))))
        (unlam' (unlam' (interpE (subst e₂ (ρ rs Θ)))))
        (λ x → s-rs-l ρ Θ e₁ x)
        (λ x → s-rs-l ρ Θ e₂ (fst (fst x)) (snd (fst x)) (snd x))
        (λ x₁ → sound (ren (subst e₁ Θ) ρ) (app (app (ren (subst e₂ Θ) ρ) rz) (ren (subst e₁ Θ) ρ)) (ren-cong (subst-cong P)) x₁)
        (λ x₁ → sound (subst e₁ (ρ rs Θ)) (app (app (subst e₂ (ρ rs Θ)) rz) (subst e₁ (ρ rs Θ))) (subst-cong P) x₁)
        (k , (Monotone.f (interpE (subst e (ρ rs Θ))) k)))
  ...
  s-rs-r-rec-lem-lem : ∀ {Γ Γ' τ} (x : CTp) (ρ : rctx Γ Γ') (k : fst [ Γ ]c) (x₁ : fst (([ Γ ]c ×p [ τ ]t) ×p (Nat , ♭nat-p)))
                     → Preorder-str.≤ (snd [ Γ' ]c)
                       (Monotone.f (interpR ρ) (Monotone.f (interpR {τ :: Γ} {Γ} iS) (Monotone.f (interpR {nat :: τ :: Γ} {τ :: Γ} iS) x₁)))
                       (Monotone.f (interpR {τ :: Γ'} {Γ'} iS) (Monotone.f (interpR {nat :: τ :: Γ'} {τ :: Γ'} iS)
                         (Monotone.f (interpR {nat :: τ :: Γ} {nat :: τ :: Γ'} (r-extend (r-extend ρ))) x₁)))
  s-rs-r-rec-lem-lem {Γ' = []} x ρ k x₁ = <>
  s-rs-r-rec-lem-lem {Γ} {Γ' = x :: Γ'} {τ} x₁ ρ k x₂ = {!!}
...
{-  s-rs-l-rec-lem-lem : ∀ {Γ Γ' τ} (x : CTp) (ρ : rctx Γ Γ') (k : fst [ Γ ]c) (x₁ : fst (([ Γ ]c ×p [ τ ]t) ×p (Nat , ♭nat-p)))
  ...
  s-rs-r {Γ} {Γ'} {Γ''} {τ} ρ Θ (rec {.Γ''} {.τ} e e₁ e₂) k =
    Preorder-str.trans (snd [ τ ]t)
     (natrec (Monotone.f (interpE (subst e₁ (λ x → ren (Θ x) ρ))) k)
       (λ n x₂ → Monotone.f (interpE (subst e₂ (s-extend (s-extend (λ x → ren (Θ x) ρ))))) ((k , x₂) , n))
       (Monotone.f (interpE (subst e (λ x → ren (Θ x) ρ))) k))
         ...
         (λ x →
           Preorder-str.trans (snd [ τ ]t)
             ...
             (Preorder-str.trans (snd [ τ ]t)
               ...
               (Monotone.f (interpE e₂) (Monotone.f (interpS {nat :: τ :: Γ} {nat :: τ :: Γ''} (s-extend (s-extend (λ x₁ → ren (Θ x₁) ρ)))) x))
               (Monotone.f (interpE (subst e₂ (r-extend (r-extend ρ) rs s-extend (s-extend Θ)))) x)
               (subst-eq-l (s-extend (s-extend (λ x₁ → ren (Θ x₁) ρ))) e₂ x)
               (Preorder-str.trans (snd [ τ ]t)
                 (Monotone.f (interpE e₂) (Monotone.f (interpS {nat :: τ :: Γ} {nat :: τ :: Γ''} (s-extend (s-extend (λ x₁ → ren (Θ x₁) ρ)))) x))
                 (Monotone.f (interpE e₂) (Monotone.f (interpS {nat :: τ :: Γ} {nat :: τ :: Γ''} (r-extend (r-extend ρ) rs s-extend (s-extend Θ))) x))
                 (Monotone.f (interpE (subst e₂ (r-extend (r-extend ρ) rs s-extend (s-extend Θ)))) x)
                 (Monotone.is-monotone (interpE e₂)
                   ...
                   Preorder-str.refl (snd [ τ ]t) (snd (fst x))) ,
                   ♭nat-refl (snd x)))
                 (subst-eq-r (r-extend (r-extend ρ) rs s-extend (s-extend Θ)) e₂ x)))
             (s-rs-r (r-extend (r-extend ρ)) (s-extend (s-extend Θ)) e₂ x)))
     (♭h-fix-args (interpE (ren (subst e₁ Θ) ρ)) (interpE (ren (subst e₂ (s-extend (s-extend Θ))) (r-extend (r-extend ρ))))
       (k , Monotone.f (interpE (subst e (λ x → ren (Θ x) ρ))) k)
       (k , Monotone.f (interpE (ren (subst e Θ) ρ)) k)
         (s-rs-r ρ Θ e k))
  ...
  s-rs-r {Γ} {Γ'} {Γ''} {τ} ρ Θ (rrec {.Γ''} {.τ} e e₁ e₂ P) k =
    Preorder-str.trans (snd [ τ ]t)
      (Monotone.f (comp (pair' id (interpE (subst e (ρ rs Θ))))
        (rec' (interpE (subst e₁ (ρ rs Θ))) (unlam' (unlam' (interpE (subst e₂ (ρ rs Θ)))))
        (sound (subst e₁ (ρ rs Θ)) (app (app (subst e₂ (ρ rs Θ)) rz) (subst e₁ (ρ rs Θ))) (subst-cong P)))) k)
      (natrec (Monotone.f (interpE (ren (subst e₁ Θ) ρ)) k)
        (λ n x₂ → Monotone.f (unlam' (unlam' (interpE (ren (subst e₂ Θ) ρ)))) ((k , n) , x₂))
        (Monotone.f (interpE (subst e (ρ rs Θ))) k))
      (Monotone.f (comp (pair' id (interpE (ren (subst e Θ) ρ)))
        (rec' (interpE (ren (subst e₁ Θ) ρ)) (unlam' (unlam' (interpE (ren (subst e₂ Θ) ρ))))
        (sound (ren (subst e₁ Θ) ρ) (app (app (ren (subst e₂ Θ) ρ) rz) (ren (subst e₁ Θ) ρ)) (ren-cong (subst-cong P))))) k)
      (h-cong2
        ...
        (unlam' (unlam' (interpE (ren (subst e₂ Θ) ρ))))
        (λ x → s-rs-r ρ Θ e₁ x)
        (λ x → s-rs-r ρ Θ e₂ (fst (fst x)) (snd (fst x)) (snd x))
        (λ x₁ → sound (subst e₁ (ρ rs Θ)) (app (app (subst e₂ (ρ rs Θ)) rz) (subst e₁ (ρ rs Θ))) (subst-cong P) x₁)
        (λ x₁ → sound (ren (subst e₁ Θ) ρ) (app (app (ren (subst e₂ Θ) ρ) rz) (ren (subst e₁ Θ) ρ)) (ren-cong (subst-cong P)) x₁)
        (k , (Monotone.f (interpE (subst e (ρ rs Θ))) k)))
      (h-lem2 (interpE (ren (subst e₁ Θ) ρ)) (unlam' (unlam' (interpE (ren (subst e₂ Θ) ρ))))
  ...
  s-rs-r {Γ} {Γ'} {Γ''} {τ} ρ Θ (listrec {.Γ''} {τ'} {.τ} e e₁ e₂) k =
    Preorder-str.trans (snd [ τ ]t)
      (lrec (Monotone.f (interpE (subst e (λ x → ren (Θ x) ρ))) k)
        (Monotone.f (interpE (subst e₁ (λ x → ren (Θ x) ρ))) k)
        (λ x₁ x₂ x₃ → Monotone.f (interpE (subst e₂ (s-extend (s-extend (s-extend (λ x → ren (Θ x) ρ)))))) (((k , x₃) , x₂) , x₁)))
          ...
          (λ x →
            Preorder-str.trans (snd [ τ ]t)
              ...
              (Preorder-str.trans (snd [ τ ]t)
                ...
                (Monotone.f (interpE e₂) (Monotone.f (interpS {τ' :: list τ' :: τ :: Γ} (s-extend (s-extend (s-extend (λ x₁ → ren (Θ x₁) ρ))))) x))
                (Monotone.f (interpE (subst e₂ (r-extend (r-extend (r-extend ρ)) rs s-extend (s-extend (s-extend Θ))))) x)
                (subst-eq-l (s-extend (s-extend (s-extend (λ x₁ → ren (Θ x₁) ρ)))) e₂ x)
                (Preorder-str.trans (snd [ τ ]t)
                  (Monotone.f (interpE e₂) (Monotone.f (interpS {τ' :: list τ' :: τ :: Γ} (s-extend (s-extend (s-extend (λ x₁ → ren (Θ x₁) ρ))))) x))
                  (Monotone.f (interpE e₂) (Monotone.f (interpS {τ' :: list τ' :: τ :: Γ} (r-extend (r-extend (r-extend ρ)) rs s-extend (s-extend (s-extend Θ)))) x))
                  (Monotone.f (interpE (subst e₂ (r-extend (r-extend (r-extend ρ)) rs s-extend (s-extend (s-extend Θ))))) x)
                  (Monotone.is-monotone (interpE e₂)
                    ...
                    l-refl (snd [ τ' ]t) (snd (fst x))) ,
                    Preorder-str.refl (snd [ τ' ]t) (snd x)))
                  (subst-eq-r (r-extend (r-extend (r-extend ρ)) rs s-extend (s-extend (s-extend Θ))) e₂ x)))
              (s-rs-r (r-extend (r-extend (r-extend ρ))) (s-extend (s-extend (s-extend Θ))) e₂ x)))
      (listrec-fix-args (interpE (ren (subst e₁ Θ) ρ)) (interpE (ren (subst e₂ (s-extend (s-extend (s-extend Θ)))) (r-extend (r-extend (r-extend ρ)))))
        (k , Monotone.f (interpE (subst e (λ x → ren (Θ x) ρ))) k)
        (k , Monotone.f (interpE (ren (subst e Θ) ρ)) k)
          (Preorder-str.refl (snd [ Γ ]c) k , s-rs-r ρ Θ e k))
  s-rs-r ρ Θ true k = <>
  s-rs-r ρ Θ false k = <>
